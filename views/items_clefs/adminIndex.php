...
<table class="table table-hover">
	...
	<tbody>
		...
		foreach ($items_clefs as $ic)
		{
			...
			echo "<td><a href='/".WEBROOT2."/items_clefs/adminEdit/".$ic->Id_Page."'><i class='fas fa-edit'></i></a>";
			echo "&nbsp;<a href='/".WEBROOT2."/items_clefs/adminDelete/".$ic->Id_Page."' onclick=\"return confirm('Voulez vous vraiment supprimer cette item clef?');\"><i class='fas fa-trash-alt'></i></a>";
			echo '</tr>';
		}
		echo "<tr>";
